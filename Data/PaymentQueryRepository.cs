...
public class PaymentQueryRepository : IPaymentQueryRepository
{
    ...
    public PaymentQueryRepository(ApplicationDbContext db)
    {
        _db = db;
    }

    public async Task<PaymentDetailResponse?> GetByIdAsync(string transactionId)
    {
    ...
    public async Task<PaymentListResponse> GetFilteredAsync(string merchantId, string? status)
    {
